...
Total: **4,409** lines of code across **37** files in the top 5 languages.
...
- **Upstream**: <https://github.com/simonomi/hexapoda>
...
- **Stars**: 159 · **Forks**: 0 · **Open issues**: 3 · **Contributors**: 1

## Totals (cumulative)

- **Releases**: 6 · **Merged PRs**: 0 · **Open PRs**: 0 · **Closed issues**: 2 · **Open issues**: 1 · **Commits**: 135
...
Reported by **5** distros on [repology.org](https://repology.org/project/hexapoda). **4** are ✅ on the latest upstream release, **0** are ⚠️ on an older version.
...
_Snapshot: `data/card/260912.yml` · 2026-09-12T04:59:23Z._
