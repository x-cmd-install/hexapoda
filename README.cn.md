...
[![x-cmd/install — hexapoda Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/hexapoda.svg?lang=zh)](https://x-cmd.com/install/hexapoda)
...
合计: **4,409** 行代码（覆盖前 5 种语言、共 **37** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Rust | 4,174 | 90 | 929 | 31 |
| Svg | 131 | 0 | 0 | 2 |
| Swift | 62 | 0 | 16 | 1 |
| Toml | 42 | 0 | 9 | 1 |
| Markdown | 0 | 41 | 9 | 2 |
...
- **上游仓库**: <https://github.com/simonomi/hexapoda>
- **官网**: <https://simonomi.dev/hexapoda>
- **许可证**: GPL-3.0
...
- **Star**: 160 · **Fork**: 0 · **开放 issue**: 3 · **贡献者**: 1

## 累计统计

- **发布数**: 6 · **已合并 PR**: 0 · **开放 PR**: 0 · **已关闭 issue**: 2 · **开放 issue**: 1 · **提交数**: 135
...
| last60d | 2026-07-26 | 1 | 0 | 0 | 0 | 0 | 8 |
| 90d | 2026-06-26 | 1 | 0 | 0 | 0 | 0 | 10 |
| last180d | 2026-03-28 | 6 | 0 | 0 | 2 | 1 | 78 |
| 360d | 2025-09-29 | 6 | 0 | 0 | 2 | 1 | 135 |
| last720d | 2024-10-04 | 6 | 0 | 0 | 2 | 1 | 135 |
...
hexapoda 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `hexapoda` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/hexapoda.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260924.yml` · 2026-09-24T05:25:42Z._
